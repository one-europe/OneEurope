...
class EasyFeature extends Plugin
{
	...
	public function action_form_publish ( $form, $post )
	{
		if ( User::identify()->can('manage_features') ) {
			$form->append( 'text', 'systags', 'null:null', _t( 'available: "slideshow", "menu", "author", "director", "ambassador", "partner", "editor", "it", "project_manager", "designer"' ), 'admincontrol_text' );
