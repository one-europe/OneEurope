...
class EasyFeature extends Plugin
{
	...
	public function action_form_publish ( $form, $post )
	{
		if ( User::identify()->can('manage_features') ) {
			$form->append( 'text', 'systags', 'null:null', _t( 'System Tags, Separated by Commas (available: "slideshow", "menu", "editor", "author", "ambassador", "partner", "former", "founder", "it")' ), 'admincontrol_text' );
