...
class Formenhancer extends Plugin
{
	...
	public function action_admin_header() {	
		...
		Stack::add('admin_header_javascript', URL::get_from_filesystem(__FILE__) . '/jquery.counter.js', 'charcountdown', 'humanmsg');
		Stack::add('admin_stylesheet', array(URL::get_from_filesystem(__FILE__) . '/jquery.counter.css', 'screen'), 'jquery' );
