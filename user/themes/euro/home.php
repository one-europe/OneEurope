			...
			foreach ($posts as $post ) {
				...
				<section>
					...
					<p class="meta">
				        ...
				        <span style="color: #fff;" class="fb-comments-count" data-href="<?php echo $item->permalink; ?>">0</span>
				        <span style="color: #fff;"><fb:comments-count href=<?php echo $item->permalink; ?>></fb:comments-count></span>
					</p>
				</section>
			<?php }} ?>
