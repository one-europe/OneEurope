...
<?php if ( $post ) { ?>
	...
	<div id="content">
		...
		<div class="breadcrumb">
			<span class="b-first"><a href="/in-brief">The Big Picture ›</a></span>
			<span class="b-title"><a href="<?php echo $post->permalink; ?>"><?php echo $post->title; ?> <?php echo $post->title; ?></a></span>
			<div class="pager">
