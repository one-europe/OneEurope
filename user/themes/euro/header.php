	...
	<body id="top" onload="initmap()">
		...
		<div id="wrapper">
			...
			<div id="head">
				...
				<a id="headerbadge" href="<?php Site::out_url( 'habari' ); ?>/europeday"><img src="<?php Site::out_url( 'theme' ); ?>/img/static/badge.jpg" width="100" height="100" alt="Celebrate Europe Day with a profile banner in your language!" /></a>
