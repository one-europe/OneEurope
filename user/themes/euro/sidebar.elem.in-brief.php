<section class="side-block">
	<a class="top-link" href="<?php echo Site::out_url( 'habari' ); ?>/in-brief">The Big Picture:</a>
		<?php
		$i = 0; $j = 1;
		...
		<?php } } ?>
		<a class="link-view-all" href="<?php echo Site::out_url( 'habari' ); ?>/in-brief" title="view all">view all</a>
</section>