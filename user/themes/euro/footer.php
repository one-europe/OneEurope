			...
			<div id="footwrap">
				...
				<div id="footer">
					...
					<div class="element partners">
						...
						<a href="http://thinkyoung.eu/" target="_blank" title="ThinkYoung lobbies for the presence of young people in European decision-making"><img src="<?php Site::out_url( 'theme' )?>/img/grey.gif" data-original="<?php Site::out_url('theme') ?>/img/supporters/thinkyoung.png" title="ThinkYoung lobbies for the presence of young people in European decision-making" alt="ThinkYoung lobbies for the presence of young people in European decision-making" height="68" width="250" /></a>
