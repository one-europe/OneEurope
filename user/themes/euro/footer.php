	...
	***/
	...
	<script>
		(function() {
			var disqus_shortname = 'oneeurope',
				...
				disqus_title = '<?php echo $post->title; ?>',
				disqus_url = '<?php echo $post->permalink; ?>',
				disqus_developer = 0, // or 1 based on if you're looking to skip URL authentication
	...
	<script src="<?php Site::out_url( 'theme' ); ?>/js/plugins.js?20140520"></script>
	<script src="<?php Site::out_url( 'theme' ); ?>/js/script.js?20140520"></script>		
