...
<div class="list-large">
	...
	<div class="pagination">
		...
		<?php echo $theme->page_selector_briefs1(null, array('leftSide' => 6, 'rightSide' => 6, 'hideIfSinglePage' => true)); ?>
		<?php echo $theme->next_page_link_briefs1(_t('Next'), array('class' => 'next')); ?>
	</div>
</div>
