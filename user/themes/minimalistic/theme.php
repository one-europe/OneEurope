...
/**
 * MyTheme is a custom Theme class for the theme.
 *
 * @package Habari
 */

// We must tell Habari to use MyTheme as the custom theme class:
// define( 'THEME_CLASS', 'MyTheme' ); // 0.6.6 to 0.7

/**
 * A custom theme for Minimal output
 */
...
Format::apply_with_hook_params( 'more', 'post_content_out', '<span class="more">more</span>', 500, 1 ); // home.php
Format::apply_with_hook_params( 'more', 'post_content_excerpt', '<span class="more">more</span>', 200, 1 ); // multiple.entry.php
...
/**
	...
	public function add_template_vars()
	{
		...
		$this->assign('recent_posts',
	                Posts::get( array('limit'=>5, 'status'=>'published', 'orderby'=>'pubdate DESC' ) ) ); //Display the 5 most recent posts
