...
<div class="panel">
	...
	<div class="content">
		...
		<dl>
		    ...
		    <?php if (( $this->_rootref['S_AL_WL_ENABLED'] || $this->_rootref['S_AL_FB_ENABLED'] || $this->_rootref['S_AL_TW_ENABLED'] ) && ! $this->_rootref['S_ADMIN_AUTH']) {  ?> 
	        ...
	        <a href="<?php echo (isset($this->_rootref['U_AL_WL_AUTHORIZE'])) ? $this->_rootref['U_AL_WL_AUTHORIZE'] : ''; ?>"><img src="alternatelogin/images/windows_live_connect.png" alt="Windows Live Connect" /></a> 
	        <?php } if ($this->_rootref['S_AL_FB_ENABLED']) {  ?> 
	            <a onclick="window.location='alternatelogin/al_fb_connect.php<?php echo (isset($this->_rootref['S_RETURN_TO_PAGE'])) ? $this->_rootref['S_RETURN_TO_PAGE'] : ''; ?>';" href="#"> 
