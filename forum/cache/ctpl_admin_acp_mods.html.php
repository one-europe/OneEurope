...
<?php if ($this->_rootref['S_WRITABLE_WARN']) {  ?>
...
<?php } if ($this->_rootref['S_FRONTEND']) {  ?>
	...
	<tbody>
	<tr>
		<td class="row3" colspan="3"><strong><?php echo ((isset($this->_rootref['L_INSTALLED_MODS'])) ? $this->_rootref['L_INSTALLED_MODS'] : ((isset($user->lang['INSTALLED_MODS'])) ? $user->lang['INSTALLED_MODS'] : '{ INSTALLED_MODS }')); ?></strong></td>
	</tr>
	<?php if (! sizeof($this->_tpldata['installed'])) {  ?>

		<tr>
			<td class="row1" colspan="3" style="text-align: center;"><?php echo ((isset($this->_rootref['L_NO_INSTALLED_MODS'])) ? $this->_rootref['L_NO_INSTALLED_MODS'] : ((isset($user->lang['NO_INSTALLED_MODS'])) ? $user->lang['NO_INSTALLED_MODS'] : '{ NO_INSTALLED_MODS }')); ?></td>
		</tr>
	...
	<tr>
		<td><strong><?php echo $_installed_val['MOD_NAME']; ?></strong></a></td>
	...
	<tr>
		<td class="row3" colspan="3"><strong><?php echo ((isset($this->_rootref['L_UNINSTALLED_MODS'])) ? $this->_rootref['L_UNINSTALLED_MODS'] : ((isset($user->lang['UNINSTALLED_MODS'])) ? $user->lang['UNINSTALLED_MODS'] : '{ UNINSTALLED_MODS }')); ?></strong></td>
	</tr>
	<?php if (! sizeof($this->_tpldata['uninstalled'])) {  ?>

	<tr>
		<td class="row1" colspan="3" style="text-align: center;"><?php echo ((isset($this->_rootref['L_NO_UNINSTALLED_MODS'])) ? $this->_rootref['L_NO_UNINSTALLED_MODS'] : ((isset($user->lang['NO_UNINSTALLED_MODS'])) ? $user->lang['NO_UNINSTALLED_MODS'] : '{ NO_UNINSTALLED_MODS }')); ?></td>
	</tr>
	...
	<tr>
		<td><strong><?php echo $_uninstalled_val['MOD_NAME']; ?></strong></a></td>
	...
	<fieldset>
		...
		<dl>
			...
			<br /><br /><input type="submit" name="submit" value="<?php echo ((isset($this->_rootref['L_UPLOAD'])) ? $this->_rootref['L_UPLOAD'] : ((isset($user->lang['UPLOAD'])) ? $user->lang['UPLOAD'] : '{ UPLOAD }')); ?>" id="submit" class="button1" />
		</dl>
	</fieldset>
	</form>
...
<?php } else if ($this->_rootref['S_DETAILS']) {  ?>
	...
	<fieldset>
		...
		<dl>
			...
			<dd><strong><?php echo $_contrib_val['MOD_NAME']; ?></strong> <?php if ($_contrib_val['U_INSTALL']) {  ?>(<a href="<?php echo $_contrib_val['U_INSTALL']; ?>"><?php echo ((isset($this->_rootref['L_INSTALL_MOD'])) ? $this->_rootref['L_INSTALL_MOD'] : ((isset($user->lang['INSTALL_MOD'])) ? $user->lang['INSTALL_MOD'] : '{ INSTALL_MOD }')); ?></a>)<?php } ?></dd>
		</dl>
		...
		<dl>
			...
			<dd><strong><?php echo $_unknown_lang_val['ENGLISH_NAME']; ?></strong> &ndash; <?php echo $_unknown_lang_val['LOCAL_NAME']; ?> <?php if ($_unknown_lang_val['U_INSTALL']) {  ?>(<a href="<?php echo $_unknown_lang_val['U_INSTALL']; ?>"><?php echo ((isset($this->_rootref['L_INSTALL_MOD'])) ? $this->_rootref['L_INSTALL_MOD'] : ((isset($user->lang['INSTALL_MOD'])) ? $user->lang['INSTALL_MOD'] : '{ INSTALL_MOD }')); ?></a>)<?php } ?></dd>
		</dl>
...
<?php if (sizeof($this->_tpldata['data'])) {  if ($this->_rootref['S_CONNECTION_SUCCESS']) {  ?>
	...
	<?php $this->_tpl_include('acp_mods_actions.html'); if ($this->_rootref['S_NEW_FILES'] || $this->_rootref['S_EDITS'] || $this->_rootref['S_SQL']) {  ?>
