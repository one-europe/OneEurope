...
<script> 
    var fb_status = "<?php echo (isset($this->_rootref['S_FB_STATUS'])) ? $this->_rootref['S_FB_STATUS'] : ''; ?>";
    ...
    var wl_status = "<?php echo (isset($this->_rootref['S_WL_STATUS'])) ? $this->_rootref['S_WL_STATUS'] : ''; ?>";
    ...
    var tw_status = "<?php echo (isset($this->_rootref['S_TW_STATUS'])) ? $this->_rootref['S_TW_STATUS'] : ''; ?>";
...
<div class="panel">
	...
	<fieldset>
            ...
            <?php if ($this->_rootref['AL_FB_USER']) {  ?> 
                    <tr> 
			<td><input type="checkbox" class="radio" name="fb_status" onclick="apply_fb_status();" <?php echo (isset($this->_rootref['S_FB_STATUS_CHECKED'])) ? $this->_rootref['S_FB_STATUS_CHECKED'] : ''; ?> /></td> 
			<td class="gen"><?php echo ((isset($this->_rootref['L_FB_STATUS'])) ? $this->_rootref['L_FB_STATUS'] : ((isset($user->lang['FB_STATUS'])) ? $user->lang['FB_STATUS'] : '{ FB_STATUS }')); ?></td> 
		</tr> 
            <?php } if ($this->_rootref['AL_WL_USER']) {  ?> 
                    <tr> 
			<td><input type="checkbox" class="radio" name="wl_status" onclick="apply_wl_status();" <?php echo (isset($this->_rootref['S_WL_STATUS_CHECKED'])) ? $this->_rootref['S_WL_STATUS_CHECKED'] : ''; ?> /></td> 
			<td class="gen"><?php echo ((isset($this->_rootref['L_WL_STATUS'])) ? $this->_rootref['L_WL_STATUS'] : ((isset($user->lang['WL_STATUS'])) ? $user->lang['WL_STATUS'] : '{ WL_STATUS }')); ?></td> 
		</tr> 
            <?php } if ($this->_rootref['AL_TW_USER']) {  ?> 
                    <tr> 
			<td><input type="checkbox" class="radio" name="tw_status" onclick="apply_tw_status();" <?php echo (isset($this->_rootref['S_TW_STATUS_CHECKED'])) ? $this->_rootref['S_TW_STATUS_CHECKED'] : ''; ?> /></td> 
			<td class="gen"><?php echo ((isset($this->_rootref['L_TW_STATUS'])) ? $this->_rootref['L_TW_STATUS'] : ((isset($user->lang['TW_STATUS'])) ? $user->lang['TW_STATUS'] : '{ TW_STATUS }')); ?></td> 
		</tr> 
...
<fieldset class="submit-buttons">
	...
	<input type="submit" name="preview" value="<?php echo ((isset($this->_rootref['L_PREVIEW'])) ? $this->_rootref['L_PREVIEW'] : ((isset($user->lang['PREVIEW'])) ? $user->lang['PREVIEW'] : '{ PREVIEW }')); ?>" class="button1" />&nbsp;
